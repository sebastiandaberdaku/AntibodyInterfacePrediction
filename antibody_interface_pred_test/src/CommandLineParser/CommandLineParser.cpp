...
bool CommandLineParser::parseCommandLine(int const & argc,
		...
		string & inname2, string & outname1, string & outname2,
		string & inname_radii, bool & no_hydrogen,
		bool & no_hetatm, int & maxOrder, float & interface_distance,
		bool & help, bool & version, bool & license) {

	//------------------------------- command line options --------------------------------------
	options_description description("Paratope prediction - Test samples generator. Usage");
