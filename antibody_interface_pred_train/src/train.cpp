...
//---------------------------variables and parameters------------------------------------
	...
	if (!CommandLineParser::parseCommandLine(argc, argv, patchRadius,
			...
			interface_distance, help, version, surf_description, license))
		return EXIT_FAILURE;
...
#pragma omp section
			{
				receptor = new Molecule(patchRadius, probeRadius, resolution,
						inname_receptor, outname_receptor,
						inname_radii, maxOrder, no_hydrogen, no_hetatm);
			}
#pragma omp section
			{
				ligand = new Molecule(patchRadius, probeRadius, resolution,
						inname_ligand, outname_ligand,
						inname_radii, maxOrder, no_hydrogen, no_hetatm, false);
			}
		}
		...
		receptor->calculateDescriptors(inname_receptor, minCenterDist_noninterface, minCenterDist_interface, patchRadius, maxOrder, complex.receptor_interface, receptor_descriptors);
